<?php
    ...
    */
    ...
    // Check URL variable "c" for codec - for Safari/iOS users, the muvi.js script will request H.265, everyone else gets H.264
    $codec = $_GET["c"];
    ...
    // The location of remote MÜVI video assets
    ...
    if ($hlslevel == 1) {
        ...
        if ($codec == "hevc") {
            ...
            // https://assets.muvidental.com/vid/gum-disease/playlist_h265.m3u8?sv=2017-11-09&ss=b&srt=o&sp=r&st=2019-07-11T06:22:31Z&se=2019-08-11T06:22:31Z&spr=https&sig=T9jrlNWxzzKqVMCc1cbQhGX0wPAH8m3oMgXzbuflgCQ%3D&pid=clue
            curl_setopt($ch, CURLOPT_URL, $asseturi . $videoid . "/playlist_h265.m3u8" . $sastoken);
        } else {
            // Authorize H.264 master playlist for everyone else.
            // This combines the static location for MÜVI assets, the specific video being requested, and the authorization token from Clue, into one request URI.
            // The request will look something like the following example:
            // https://assets.muvidental.com/vid/gum-disease/playlist.m3u8?sv=2017-11-09&ss=b&srt=o&sp=r&st=2019-07-11T06:22:31Z&se=2019-08-11T06:22:31Z&spr=https&sig=T9jrlNWxzzKqVMCc1cbQhGX0wPAH8m3oMgXzbuflgCQ%3D&pid=clue
        ...
        // https://assets.muvidental.com/vid/gum-disease/1440p_h265_init.mp4?sv=2017-11-09&ss=b&srt=o&sp=r&st=2019-07-11T06:22:31Z&se=2019-08-11T06:22:31Z&spr=https&sig=T9jrlNWxzzKqVMCc1cbQhGX0wPAH8m3oMgXzbuflgCQ%3D&pid=clue
        ...
        // The resulting URIs will look something like the following example:
        // https://assets.muvidental.com/vid/gum-disease/1080p_000.ts?sv=2017-11-09&ss=b&srt=o&sp=r&st=2019-07-11T06:22:31Z&se=2019-08-11T06:22:31Z&spr=https&sig=T9jrlNWxzzKqVMCc1cbQhGX0wPAH8m3oMgXzbuflgCQ%3D&pid=clue
        $pattern = '/[^\n]*\.ts[^\n]*/';
        ...
        // Parse the response and convert all relative movie segment URIs to absolute and also add authorzation token
        // The resulting URIs will look something like the following example:
        // https://assets.muvidental.com/vid/gum-disease/1440p_h265_000.m4s?sv=2017-11-09&ss=b&srt=o&sp=r&st=2019-07-11T06:22:31Z&se=2019-08-11T06:22:31Z&spr=https&sig=T9jrlNWxzzKqVMCc1cbQhGX0wPAH8m3oMgXzbuflgCQ%3D&pid=clue
        $pattern = '/[^\n]*\.m4s[^\n]*/';
        $output = preg_replace($pattern, $asseturi . $videoid . '/$0' . $sastoken, $output);
